...
class CreateOrderConfig implements \LisaoPayment\ConfigBase\InterfaceConfig {
    ...
    public $method = 'alipay.trade.create'; //请求类型
    private $param = []; //参数
    ...
    /**
     * 买家的支付宝唯一用户号
     * @param string $value （2088开头的16位纯数字）,和buyer_logon_id不能同时为空
     */
    public function set_buyer_id( string $value) {
         $this->param['buyer_id'] = $value;
    }
