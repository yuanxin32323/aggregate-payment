...
class QueryOrderConfig implements \LisaoPayment\ConfigBase\InterfaceConfig {
    ...
    private $product_url = 'https://api.mch.weixin.qq.com/pay/orderquery'; //生产环境请求接口
    private $sandbox_url = 'https://api.mch.weixin.qq.com/sandboxnew/pay/orderquery'; //沙箱环境请求接口
    private $param = []; //参数
